...
from .serializers import (
    ...
    Blog_List_Serializer , Section_list_Serializer
)
import openai
...
class BlogViewSet(viewsets.ModelViewSet):
    ...
    def get_queryset(self):
        ...
        return Blog.objects.filter(admin__user=self.request.user)
...
class SectionViewSet(viewsets.ModelViewSet):
    ...
    # def get_serializer_class(self):
    #     if self.action == 'list':
    #         return Section_list_Serializer  # for GET /blogs/
    #     return SectionSerializer  # for GET /blogs/<id>/, POST, PUT, etc.
    
    def get_queryset(self):
        return Section.objects.filter(blog__author=self.request.user)
...
class CommentViewSet(viewsets.ModelViewSet):
    ...
    def get_queryset(self):
        return Comment.objects.filter(section__blog__author=self.request.user)
